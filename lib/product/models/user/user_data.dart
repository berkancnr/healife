...
class UserData {
  ...
  @JsonKey(toJson: _userSexToJson, fromJson: _userSexFromJson)
  UserSex sex;
  int followerCount;
  int followingCount;
  int chatCount;
...
UserSex _userSexFromJson(int sexCode) {
  return UserSex.values[sexCode];
}

int _userSexToJson(UserSex sex) {
  return sex.index;
}
