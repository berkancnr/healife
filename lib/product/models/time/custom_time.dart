...
//
//     final customTime = customTimeFromJson(jsonString);

import 'dart:convert';

CustomTime customTimeFromJson(String str) => CustomTime.fromJson(json.decode(str));

String customTimeToJson(CustomTime data) => json.encode(data.toJson());
