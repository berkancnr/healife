...
abstract class TextConstants {
  ...
  static const TextStyle profileCountTextStyle = TextStyle(fontSize: 18, fontWeight: FontWeight.bold);
  static const TextStyle profileCountDescTextStyle = TextStyle(fontSize: 10, fontWeight: FontWeight.bold);
